...
* @returns {string}
*/
export function createNewMessage(original) {
    let deferred2_0;
    let deferred2_1;
    try {
...
* @returns {string}
*/
export function sign(salted_message) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {boolean}
*/
export function validate(original_message, signature) {
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('vsda_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
